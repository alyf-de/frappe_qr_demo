...
class QRDemo(Document):
	def validate(self):
		self.qr_code = get_qr_code(self.title, format="PNG")


def get_qr_code(data, format: str):
	qr_code_bytes = get_qr_code_bytes(data, format)
...
def get_qr_code_bytes(data, format: str):
